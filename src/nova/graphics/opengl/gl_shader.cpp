...
void GLShader::set_uniform(const std::string& name, const glm::ivec2& value)
{
  GLint location = get_uniform_location(name);
  if (location != -1)
...
void GLShader::set_uniform(const std::string& name, const glm::ivec3& value)
{
  GLint location = get_uniform_location(name);
  if (location != -1)
...
void GLShader::set_uniform(const std::string& name, const glm::ivec4& value)
{
  GLint location = get_uniform_location(name);
  if (location != -1)
...
void GLShader::set_uniform(const std::string& name, const glm::vec2& value)
{
  GLint location = get_uniform_location(name);
  if (location != -1)
...
void GLShader::set_uniform(const std::string& name, const glm::mat3& value)
{
  GLint location = get_uniform_location(name);
  if (location != -1)
